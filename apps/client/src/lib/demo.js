...
/* Where *this* project's source lives. Every "self-host GymBuddy" link points here, and under
 ...
 * until now, which sent everyone who tapped "Self-host GymBuddy" to a different product.
 *
 * Empty until GymBuddy has a public repository (docs/PUBLISHING.md). Every link that uses it
