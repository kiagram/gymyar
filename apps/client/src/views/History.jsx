...
import { WorkoutRow, workoutDetailSheet, textLogSheet } from '../sheets.jsx'
...
export default function History() {
  ...
  return <>
    <div className="hdr"><button className="iconbtn" onClick={() => nav('/stats')} aria-label={t('Stats')}><Icon name="chevronLeft" /></button>
      ...
      <button className="iconbtn" onClick={textLogSheet} aria-label={t('Log by typing')} title={t('Log by typing')}><Icon name="pencil" /></button></div>
